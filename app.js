...
function bindBody(){
 ...
 const money=$("#moneyInput"); if(money) money.onchange=()=>{const value=Math.max(0,Math.floor(Number(money.value)||0));state[selected].money=value;save();render()};
