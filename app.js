...
function bindBody(){
 ...
 document.querySelectorAll("[data-toggle-effect]").forEach(b=>b.onclick=e=>{e.preventDefault();e.stopPropagation();toggleEffect(b.dataset.toggleEffect,b.dataset.effectName)});
